...
C++ and SQL are recognised by extension and reported as unsupported until their resolvers
land. COBOL and ABL are out of scope for now, and their extensions (`.cls`, `.i`, `.p`,
